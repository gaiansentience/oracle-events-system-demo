...
as
    ...
    begin
        ...
        for r in d loop
            i_event := i_event + 1;
            l_series_event.event_date := r.the_date;
            l_event.event_date := r.the_date;
            begin
                create_event(p_event => l_event);
                
                l_series_event.event_id := l_event.event_id;    
                l_series_event.status_code := 'SUCCESS';
                l_series_event.status_message := 'Event Created';
                v_success_count := v_success_count + 1;
                v_success_dates := v_success_dates || to_char(r.the_date,'MM/DD/YYYY') || ', ';
            exception
                when others then
                    l_series_event.status_code := 'ERROR';
                    l_series_event.status_message := sqlerrm;
                    l_series_event.event_id := 0;
            ...
            p_status_details(i_event) := l_series_event;
    ...
    is
        t_status_details t_series_event;
    ...
    begin
        ...
        show_ticket_groups(p_event_id, rc);
    ...
    begin
        ...
        show_ticket_groups_event_series(p_event_series_id, rc);
        fetch rc bulk collect into t_rows;
        close rc;
    ...
    begin
        ...
        l_event_series_id := event_api.get_event_series_id(p_event_id);
        case
    ...
    begin
        ...
        show_ticket_assignments(p_event_id, p_reseller_id, rc);
        fetch rc bulk collect into t_rows;
        close rc;
    ...
    begin
        ...
        show_ticket_assignments_event_series(p_event_series_id, p_reseller_id, rc);
        fetch rc bulk collect into t_rows;
        close rc;
