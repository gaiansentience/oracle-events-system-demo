...
from 
--tablespaces
--dbfiles where tablespace_name like 'EVENT%'
--freespace where tablespace_name like 'EVENT%'
--extents where tablespace_name like 'EVENT%'
userspace where owner = 'EVENT_SYSTEM'
--userextents  where owner = 'EVENT_SYSTEM'