create or replace view customer_purchase_tickets_v_json_verify as
with base as
(
    select
        customer_id
        ...
        ,ticket_sales_id
        ,json_doc
    from customer_purchase_tickets_v_json
)
select
    b.customer_id
    ...
    ,j.price_category
    ,b.ticket_sales_id
    ,j.ticket_sales_id as ticket_sales_id_json
    ,j.ticket_quantity
