...
(
    select
        ...
        ,event_series_id
        ,xml_doc
    from event_series_ticket_prices_v_xml
...
select 
    ...
    ,g.price_category
    ,g.price
    ,g.tickets_available_all_events
    ,g.tickets_sold_all_events
    ,g.tickets_remaining_all_events
from 
    base b,
    xmltable('/event_series_ticket_prices' passing b.xml_doc 
        columns
