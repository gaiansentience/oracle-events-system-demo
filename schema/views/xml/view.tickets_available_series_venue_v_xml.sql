create or replace view tickets_available_series_venue_v_xml as
with xml_base as
(
    select
        e.venue_id
        ...
        ,xmlelement("event_series_ticket_availability"
            ,xmlelement("ticket_sources", 'VENUE DIRECT SALES')
                    ...
                    xmlagg(
                        xmlelement("ticket_group"
                            ...
                            ,xmlelement("ticket_resellers"
                                ...
                                from event_system.tickets_available_series_venue_v ta 
                                where 
