...
/*  reply document for duplicate name
{
  ...
  "reseller_id" : 0,
  "status_code" : "ERROR",
  "status_message" : "ORA-00001: unique constraint (TOPTAL.RESELLERS_U_RESELLER_NAME) violated"
}
*/

/*  reply document for duplicate email
{
  "reseller_name" : "other Ticket Factory",
  "reseller_email" : "ticket.sales@TicketFactory.com",
  "commission_percent" : 0.09,
  "reseller_id" : 0,
  "status_code" : "ERROR",
  "status_message" : "ORA-00001: unique constraint (TOPTAL.RESELLERS_U_RESELLER_EMAIL) violated"
}
*/
