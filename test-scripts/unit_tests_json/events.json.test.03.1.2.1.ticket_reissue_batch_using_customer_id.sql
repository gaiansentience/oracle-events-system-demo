...
for i in 1..3 loop
    select t.serial_code, t.status into l_new_serial_code, l_status
    from tickets t where t.ticket_id = l_tickets(i).ticket_id;
    l_json_doc := replace(l_json_doc, '$$SERIAL' || i || '$$', l_new_serial_code);
end loop;
    events_json_api.ticket_reissue_batch(p_json_doc => l_json_doc);   
    dbms_output.put_line(events_json_api.format_json_string(l_json_doc));
...
original serial code = G2442C529S80201D20220713120938Q0003I0002, status is ISSUED
original serial code = G2442C529S80201D20220713120938Q0003I0003, status is ISSUED
{
  "action" : "ticket_reissue_batch",
  "customer_id" : 529,
  "tickets" :
...
after reissuing ticket serial code = G2442C529S80201D20220713120938Q0003I0002R, status is REISSUED
after reissuing ticket serial code = G2442C529S80201D20220713120938Q0003I0003R, status is REISSUED
try to reissue tickets using new serial code
{
  ...
  [
    ...
    {
      "serial_code" : "G2442C529S80201D20220713120938Q0003I0002R",
      "status_code" : "ERROR",
      "status_message" : "ORA-20100: Ticket has already been reissued, cannot reissue twice."
    },
    {
      "serial_code" : "G2442C529S80201D20220713120938Q0003I0003R",
      "status_code" : "ERROR",
      "status_message" : "ORA-20100: Ticket has already been reissued, cannot reissue twice."
    }
  ],
...
try to reissue tickets using original serial code
{
  ...
  [
    ...
    },
    {
      "serial_code" : "G2442C529S80201D20220713120938Q0003I0002",
      "status_code" : "ERROR",
      "status_message" : "ORA-20100: Ticket not found for serial code = G2442C529S80201D20220713120938Q0003I0002"
    },
    {
      "serial_code" : "G2442C529S80201D20220713120938Q0003I0003",
      "status_code" : "ERROR",
      "status_message" : "ORA-20100: Ticket not found for serial code = G2442C529S80201D20220713120938Q0003I0003"
    }
  ],
  "request_status" : "ERRORS",
  "request_errors" : 3
