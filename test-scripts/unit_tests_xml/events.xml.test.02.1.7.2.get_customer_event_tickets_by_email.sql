set serveroutput on;
declare
  p_customer_email varchar2(50) := 'Kathy.Barry@example.customer.com';
  p_event_id number := 1;
  l_xml xmltype;
begin

  l_xml := events_xml_api.get_customer_event_tickets_by_email(p_customer_email => p_customer_email,p_event_id => p_event_id,p_formatted => true);
