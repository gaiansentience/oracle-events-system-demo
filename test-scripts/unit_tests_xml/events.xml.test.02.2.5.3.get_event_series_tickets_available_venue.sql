...
begin
  ...
  l_xml := events_xml_api.get_event_series_tickets_available_venue(p_event_series_id => p_event_series_id,p_formatted => true);
  ...
  <ticket_groups>
    <ticket_group>
      ...
      <ticket_resellers>
        <reseller>
          ...
          <tickets_available>1300</tickets_available>
    ...
    <ticket_group>
      ...
      <ticket_resellers>
        <reseller>
          <reseller_name>VENUE DIRECT SALES</reseller_name>
          <tickets_available>520</tickets_available>
          <events_available>13</events_available>
          <events_sold_out>0</events_sold_out>
        </reseller>
      </ticket_resellers>
