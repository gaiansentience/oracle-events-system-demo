...
l_xml_doc := xmltype(l_xml);
    ...
    --reset the serial codes and status to ISSUED and original serial codes    
...
<ticket_reissue_batch>
  ...
  <tickets>
    <ticket>
      <serial_code>G2484C3961S80343D20220715170741Q0004I0001R</serial_code>
      <status_code>ERROR</status_code>
      <status_message>ORA-20100: Ticket has already been reissued, cannot reissue twice.</status_message>
    </ticket>
    <ticket>
      <serial_code>G2484C3961S80343D20220715170741Q0004I0002R</serial_code>
      <status_code>ERROR</status_code>
      <status_message>ORA-20100: Ticket has already been reissued, cannot reissue twice.</status_message>
    </ticket>
    <ticket>
      <serial_code>G2484C3961S80343D20220715170741Q0004I0003R</serial_code>
      <status_code>ERROR</status_code>
      <status_message>ORA-20100: Ticket has already been reissued, cannot reissue twice.</status_message>
    </ticket>
  </tickets>
...
<ticket_reissue_batch>
  ...
  <tickets>
    <ticket>
      <serial_code>G2484C3961S80343D20220715170741Q0004I0001</serial_code>
      <status_code>ERROR</status_code>
      <status_message>ORA-20100: Ticket not found for serial code = G2484C3961S80343D20220715170741Q0004I0001</status_message>
    </ticket>
    <ticket>
      <serial_code>G2484C3961S80343D20220715170741Q0004I0002</serial_code>
      <status_code>ERROR</status_code>
      <status_message>ORA-20100: Ticket not found for serial code = G2484C3961S80343D20220715170741Q0004I0002</status_message>
    </ticket>
    <ticket>
      <serial_code>G2484C3961S80343D20220715170741Q0004I0003</serial_code>
      <status_code>ERROR</status_code>
      <status_message>ORA-20100: Ticket not found for serial code = G2484C3961S80343D20220715170741Q0004I0003</status_message>
    </ticket>
  </tickets>
  <request_status>ERRORS</request_status>
  <request_errors>3</request_errors>
